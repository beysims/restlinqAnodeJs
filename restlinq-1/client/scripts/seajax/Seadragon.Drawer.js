...
(function() {
    ...
    var useCanvas = true; // hasCanvas && !badCanvas;
    ...
    SeadragonDrawer = Seadragon.Drawer = function(source, viewport, elmt) {
        ...
        var canvas = globalCanvas = SeadragonUtils.makeNeutralElement(useCanvas ? "canvas" : "div");
        var context = globalContext = useCanvas ? canvas.getContext("2d") : null;
        ...
        function updateActual() {
            ...
            var viewportBounds = globalBounds = viewport.getBounds(true);
